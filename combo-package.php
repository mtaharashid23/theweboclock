<!-- Header -->
<?php $title = "Combo Packages | Westgreensolutionsllc";
...
<section class="bannerSec innerBannerSec packageBannerSec">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-md-7">
                <h1 class="section-heading gradient-heading">Combo Packages</h1>
            ...
            <div class="col-lg-5 col-md-4">
                <div class="banner-right">
                    <img data-src="images/combo-package.png" alt="combo-package" class="img-fluid lazy">
                </div>
            </div>
        </div>
    </div>
...
<section class="pricing">
    <div class="container">
        ...
        <div class="row justify-content-center combo-pricing-row">
